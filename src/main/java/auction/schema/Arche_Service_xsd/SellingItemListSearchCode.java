...
public class SellingItemListSearchCode implements java.io.Serializable {
    ...
    // Constructor
    protected SellingItemListSearchCode(String value) {
        _value_ = value;
    ...
    public static SellingItemListSearchCode fromValue(String value)
    ...
    public static SellingItemListSearchCode fromString(String value)
          throws IllegalArgumentException {
