...
public class SellPlusItemSearchTermCode implements java.io.Serializable {
    ...
    // Constructor
    protected SellPlusItemSearchTermCode(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _RegistDate = "RegistDate";
    public static final String _BeginDate = "BeginDate";
    public static final String _CloseDate = "CloseDate";
    ...
    public static SellPlusItemSearchTermCode fromValue(String value)
    ...
    public static SellPlusItemSearchTermCode fromString(String value)
          throws IllegalArgumentException {
