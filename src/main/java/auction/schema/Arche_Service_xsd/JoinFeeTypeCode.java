...
public class JoinFeeTypeCode implements java.io.Serializable {
    ...
    // Constructor
    protected JoinFeeTypeCode(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _None = "None";
    public static final String _JoinNAndUsimY = "JoinNAndUsimY";
    public static final String _JoinYAndUsimN = "JoinYAndUsimN";
    public static final String _JoinYAndUsimY = "JoinYAndUsimY";
    ...
    public static JoinFeeTypeCode fromValue(String value)
    ...
    public static JoinFeeTypeCode fromString(String value)
          throws IllegalArgumentException {
