...
public class ChildProductSafeCertInputType implements java.io.Serializable {
    ...
    // Constructor
    protected ChildProductSafeCertInputType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _SystemInput = "SystemInput";
    public static final String _UserInput = "UserInput";
    ...
    public static ChildProductSafeCertInputType fromValue(String value)
    ...
    public static ChildProductSafeCertInputType fromString(String value)
          throws IllegalArgumentException {
