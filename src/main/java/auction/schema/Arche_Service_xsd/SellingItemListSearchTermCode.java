...
public class SellingItemListSearchTermCode implements java.io.Serializable {
    ...
    // Constructor
    protected SellingItemListSearchTermCode(String value) {
        _value_ = value;
    ...
    public static SellingItemListSearchTermCode fromValue(String value)
    ...
    public static SellingItemListSearchTermCode fromString(String value)
          throws IllegalArgumentException {
