...
public class ChildProductSafeCertType implements java.io.Serializable {
    ...
    // Constructor
    protected ChildProductSafeCertType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _RequireCert = "RequireCert";
    public static final String _NotCert = "NotCert";
    public static final String _AddDescription = "AddDescription";
    public static final String _RequireCertWithAPI = "RequireCertWithAPI";
    ...
    public static ChildProductSafeCertType fromValue(String value)
    ...
    public static ChildProductSafeCertType fromString(String value)
          throws IllegalArgumentException {
