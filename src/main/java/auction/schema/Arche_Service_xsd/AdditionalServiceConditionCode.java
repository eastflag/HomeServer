...
public class AdditionalServiceConditionCode implements java.io.Serializable {
    ...
    // Constructor
    protected AdditionalServiceConditionCode(String value) {
        _value_ = value;
    ...
    public static final String _WithInThree = "WithInThree";
    public static final String _WithInSeven = "WithInSeven";
    ...
    public static AdditionalServiceConditionCode fromValue(String value)
    ...
    public static AdditionalServiceConditionCode fromString(String value)
          throws IllegalArgumentException {
