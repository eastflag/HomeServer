...
public class RawMaterialsType implements java.io.Serializable {
    ...
    // Constructor
    protected RawMaterialsType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _None = "None";
    public static final String _Inside = "Inside";
    public static final String _ProcessedProduct = "ProcessedProduct";
    public static final String _FarmProduct = "FarmProduct";
    public static final String _MarineProduct = "MarineProduct";
    ...
    public static RawMaterialsType fromValue(String value)
    ...
    public static RawMaterialsType fromString(String value)
          throws IllegalArgumentException {
