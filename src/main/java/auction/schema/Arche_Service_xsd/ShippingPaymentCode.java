...
public class ShippingPaymentCode implements java.io.Serializable {
    ...
    // Constructor
    protected ShippingPaymentCode(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _Free = "Free";
    public static final String _PayOnArrival = "PayOnArrival";
    ...
    public static ShippingPaymentCode fromValue(String value)
    ...
    public static ShippingPaymentCode fromString(String value)
          throws IllegalArgumentException {
