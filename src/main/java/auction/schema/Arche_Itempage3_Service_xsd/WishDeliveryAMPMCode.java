...
public class WishDeliveryAMPMCode implements java.io.Serializable {
    ...
    // Constructor
    protected WishDeliveryAMPMCode(String value) {
        _value_ = value;
    ...
    public static WishDeliveryAMPMCode fromValue(String value)
    ...
    public static WishDeliveryAMPMCode fromString(String value)
          throws IllegalArgumentException {
