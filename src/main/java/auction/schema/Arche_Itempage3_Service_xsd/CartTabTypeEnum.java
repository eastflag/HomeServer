...
public class CartTabTypeEnum implements java.io.Serializable {
    ...
    // Constructor
    protected CartTabTypeEnum(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _General = "General";
    public static final String _Mart = "Mart";
    public static final String _Lotte = "Lotte";
    public static final String _MartOn = "MartOn";
    ...
    public static CartTabTypeEnum fromValue(String value)
    ...
    public static CartTabTypeEnum fromString(String value)
          throws IllegalArgumentException {
