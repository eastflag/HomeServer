/**
 * AddGroupToFavoriteGroupListResponseT.java
 *
...
public class AddGroupToFavoriteGroupListResponseT  implements java.io.Serializable {
    private FavoriteGroupResultT[] favoriteGroupResult;

    public AddGroupToFavoriteGroupListResponseT() {
    }
    ...
    /**
     * Gets the favoriteGroupResult value for this AddGroupToFavoriteGroupListResponseT.
     * 
    ...
    /**
     * Sets the favoriteGroupResult value for this AddGroupToFavoriteGroupListResponseT.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof AddGroupToFavoriteGroupListResponseT)) return false;
        AddGroupToFavoriteGroupListResponseT other = (AddGroupToFavoriteGroupListResponseT) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddGroupToFavoriteGroupListResponseT.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schema.auction.co.kr/Arche.Sell3.Service.xsd", "AddGroupToFavoriteGroupListResponseT"));
