/**
 * GetItemLocationKoreaRequestT.java
 *
...
public class GetItemLocationKoreaRequestT  implements java.io.Serializable {
    private auction.schema.Arche_Service_xsd.MemberTicketT memberTicket;

    private String itemID;

    public GetItemLocationKoreaRequestT() {
    }
    ...
    /**
     * Gets the memberTicket value for this GetItemLocationKoreaRequestT.
     * 
     * @return memberTicket
     */
    ...
    /**
     * Sets the memberTicket value for this GetItemLocationKoreaRequestT.
     * 
     * @param memberTicket
     */
    ...
    /**
     * Gets the itemID value for this GetItemLocationKoreaRequestT.
     * 
     * @return itemID
     */
    ...
    /**
     * Sets the itemID value for this GetItemLocationKoreaRequestT.
     * 
     * @param itemID
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetItemLocationKoreaRequestT)) return false;
        GetItemLocationKoreaRequestT other = (GetItemLocationKoreaRequestT) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetItemLocationKoreaRequestT.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schema.auction.co.kr/Arche.Sell3.Service.xsd", "GetItemLocationKoreaRequestT"));
