/**
 * ReviseFavoriteGroupResponseT.java
 *
...
public class ReviseFavoriteGroupResponseT  implements java.io.Serializable {
    private FavoriteGroupResultT[] favoriteGroupResult;

    public ReviseFavoriteGroupResponseT() {
    }
    ...
    /**
     * Gets the favoriteGroupResult value for this ReviseFavoriteGroupResponseT.
     * 
    ...
    /**
     * Sets the favoriteGroupResult value for this ReviseFavoriteGroupResponseT.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ReviseFavoriteGroupResponseT)) return false;
        ReviseFavoriteGroupResponseT other = (ReviseFavoriteGroupResponseT) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReviseFavoriteGroupResponseT.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schema.auction.co.kr/Arche.Sell3.Service.xsd", "ReviseFavoriteGroupResponseT"));
