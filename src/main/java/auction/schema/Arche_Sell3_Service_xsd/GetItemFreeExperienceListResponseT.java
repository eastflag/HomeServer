...
public class GetItemFreeExperienceListResponseT  implements java.io.Serializable {
    private auction.schema.Arche_Service_xsd.ItemFreeExperienceListT itemFreeExperience;
    ...
    public GetItemFreeExperienceListResponseT(
           auction.schema.Arche_Service_xsd.ItemFreeExperienceListT itemFreeExperience,
           int totalCount) {
     ...
     */
    public auction.schema.Arche_Service_xsd.ItemFreeExperienceListT getItemFreeExperience() {
        return itemFreeExperience;
    }
     ...
     */
    public void setItemFreeExperience(auction.schema.Arche_Service_xsd.ItemFreeExperienceListT itemFreeExperience) {
        this.itemFreeExperience = itemFreeExperience;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schema.auction.co.kr/Arche.Service.xsd", "ItemFreeExperienceListT"));
