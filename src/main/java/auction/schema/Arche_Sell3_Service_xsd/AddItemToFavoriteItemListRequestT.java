...
public class AddItemToFavoriteItemListRequestT  implements java.io.Serializable {
    ...
    private FavoriteItemListT[] favoriteItemList;
    ...
    public AddItemToFavoriteItemListRequestT(
           ...
           FavoriteItemListT[] favoriteItemList,
           int version) {
     ...
     */
    public FavoriteItemListT[] getFavoriteItemList() {
        return favoriteItemList;
    }
     ...
     */
    public void setFavoriteItemList(FavoriteItemListT[] favoriteItemList) {
        this.favoriteItemList = favoriteItemList;
    }

    public FavoriteItemListT getFavoriteItemList(int i) {
        return this.favoriteItemList[i];
    }

    public void setFavoriteItemList(int i, FavoriteItemListT _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getFavoriteItemList() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getFavoriteItemList(), i);
                if (obj != null &&
