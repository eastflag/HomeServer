/**
 * AddGroupToFavoriteGroupListRequestT.java
 *
...
public class AddGroupToFavoriteGroupListRequestT  implements java.io.Serializable {
    ...
    public AddGroupToFavoriteGroupListRequestT() {
    }
    ...
    /**
     * Gets the memberTicket value for this AddGroupToFavoriteGroupListRequestT.
     * 
     * @return memberTicket
     */
    ...
    /**
     * Sets the memberTicket value for this AddGroupToFavoriteGroupListRequestT.
     * 
     * @param memberTicket
     */
    ...
    /**
     * Gets the favoriteGroupList value for this AddGroupToFavoriteGroupListRequestT.
     * 
    ...
    /**
     * Sets the favoriteGroupList value for this AddGroupToFavoriteGroupListRequestT.
     * 
    ...
    /**
     * Gets the version value for this AddGroupToFavoriteGroupListRequestT.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this AddGroupToFavoriteGroupListRequestT.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof AddGroupToFavoriteGroupListRequestT)) return false;
        AddGroupToFavoriteGroupListRequestT other = (AddGroupToFavoriteGroupListRequestT) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddGroupToFavoriteGroupListRequestT.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schema.auction.co.kr/Arche.Sell3.Service.xsd", "AddGroupToFavoriteGroupListRequestT"));
