/**
 * DeleteFavoriteStoreGroupRequestT.java
 *
...
public class DeleteFavoriteStoreGroupRequestT  implements java.io.Serializable {
    ...
    public DeleteFavoriteStoreGroupRequestT() {
    }
    ...
    /**
     * Gets the memberTicket value for this DeleteFavoriteStoreGroupRequestT.
     * 
     * @return memberTicket
     */
    ...
    /**
     * Sets the memberTicket value for this DeleteFavoriteStoreGroupRequestT.
     * 
     * @param memberTicket
     */
    ...
    /**
     * Gets the groupNo value for this DeleteFavoriteStoreGroupRequestT.
     * 
     * @return groupNo
     */
    ...
    /**
     * Sets the groupNo value for this DeleteFavoriteStoreGroupRequestT.
     * 
     * @param groupNo
     */
    ...
    /**
     * Gets the version value for this DeleteFavoriteStoreGroupRequestT.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this DeleteFavoriteStoreGroupRequestT.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof DeleteFavoriteStoreGroupRequestT)) return false;
        DeleteFavoriteStoreGroupRequestT other = (DeleteFavoriteStoreGroupRequestT) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteFavoriteStoreGroupRequestT.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schema.auction.co.kr/Arche.Sell3.Service.xsd", "DeleteFavoriteStoreGroupRequestT"));
